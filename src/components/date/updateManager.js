...
import { selectedUpdateHandler } from "../charts/series/helpers/stockUpdateFunctions";
...
const updateManager = async (dateObject) => {
  ...
  const updatedDailyObjs = transferItems(
    "Daily",
    day,
    historyObject,
    futureObject
  ...
  const updatedWeeklyObjs = transferItems(
    "Weekly",
    week,
    historyObject,
    futureObject
  ...
  const updatedMonthlyObjs = transferItems(
    "Monthly",
    month,
    historyObject,
    futureObject
